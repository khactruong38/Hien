const contentLetterSrart_actived = "Chúc mừng sinh nhật Hiền! Chúc mừng sinh nhật đặc biệt của bạn vào ngày 19/9! Ngày này không chỉ là một dịp để kỷ niệm thêm một năm tuổi mới mà còn là cơ hội để bắt đầu một hành trình mới đầy hứng thú và thành công. Hy vọng rằng bạn sẽ có một ngày sinh nhật tràn đầy niềm vui, hạnh phúc và bất ngờ. Cùng với sự ủng hộ và tình yêu của gia đình, bạn sẽ vượt qua mọi thách thức và đạt được những ước mơ lớn lao trong cuộc sống. Hãy tận hưởng mọi khoảnh khắc của ngày hôm nay, và hy vọng rằng tương lai sẽ đem lại cho bạn nhiều niềm vui, sức khỏe, và thành công. Sinh nhật vui vẻ, Hiền! 🎂🎉🎁" //Lời mở đầu cho bức thư
